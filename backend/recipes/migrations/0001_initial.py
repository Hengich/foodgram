    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Не менее одной минуты!'), django.core.validators.MaxValueValidator(1000, message='Это очень долго!')], verbose_name='Время приготовления блюда')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Не менее 1!'), django.core.validators.MaxValueValidator(10000, message='Не более 10000!')], verbose_name='Количество')),
